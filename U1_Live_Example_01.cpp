...
int main() {
    ...
    farmSensors.push_back(SoilSensor("S001", 45.2, "08:00"));
    farmSensors.push_back(SoilSensor("S002", 52.8, "08:00"));
    farmSensors.push_back(SoilSensor("S003", 38.5, "08:00"));

    cout << "== Morning Sensor Readings ==" << endl;
    for (int i = 0; i < farmSensors.size(); i++) {
        farmSensors[i].displayData();
    }
